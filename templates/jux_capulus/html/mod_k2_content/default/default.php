    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <?php echo $item->event->K2BeforeDisplayContent; ?>
		...
		<div class="moduleItemIntrotext">
			...
			<div class="moduleItemImage grow-up drop-shadow">
			...
			<div class="moduleItemIntrotext">
			<?php
				if(strlen($item->introtext) > $params->get('itemIntroTextWordLimit', 50)) {
					echo substr($item->introtext, 0, $params->get('itemIntroTextWordLimit', 50)).'...';
				} else {
					echo $item->introtext;
				}			
			?>
