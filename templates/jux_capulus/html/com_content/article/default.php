...
?>
	...
	<?php if ($useDefList && ($info == 0 || $info == 2)) : ?>
		<div class="article-info muted">
			...
			<?php if ($params->get('show_publish_date')) : ?>
				<dd class="published">
					<?php echo JText::sprintf('JUX_CAPULUS_COM_CONTENT_PUBLISHED_DATE_ON', '<span>'.JHtml::_('date', $this->item->publish_up, JText::_('DATE_FORMAT_LC3')).'</span>'); ?> 
				</dd>
			<?php endif; ?>
	...
	<?php if ($params->get('show_tags', 1) && !empty($this->item->tags)) : ?>
		...
		<?php echo JText::sprintf('JUX_CAPULUS_COM_CONTENT_TAG'); ?>
		<span><?php echo $this->item->tagLayout->render($this->item->tags->itemTags); ?></span>
	<?php endif; ?>
