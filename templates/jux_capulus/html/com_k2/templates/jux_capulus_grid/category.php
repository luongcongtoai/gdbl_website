...
<div id="k2Container" class="clearfix itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListSubCategories">
			...
			<div class="subCategoryContainer<?php echo $lastContainer; ?> col-md-<?php echo 12/$subCatColumns; ?> col-sm-6 col-xs-12">
				<div class="subCategory">
					...
					<?php if($this->params->get('catItemReadMore')): ?>
					<!-- Subcategory more... -->
	...
	<div class="itemList">
		...
		<!-- Primary items -->
		<div id="itemListPrimary clearfix">
			...
			<div class="itemContainer<?php echo $lastContainer; ?> col-md-<?php echo 12/$num_primary_columns; ?> col-sm-6 col-xs-12">
				<?php
					// Load category_item.php by default
					$this->item=$item;
					echo $this->loadTemplate('item');
