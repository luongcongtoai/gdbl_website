...
$latestItemsCols = $this->params->get('latestItemsCols');
?>
...
<div id="k2Container" class="latestView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="latestItemsContainer col-md-<?php echo 12/$latestItemsCols; ?> col-sm-<?php echo 12/$latestItemsCols; ?> col-xs-12">
	...
	<?php if(($key+1)%($latestItemsCols)==0): ?>
	<div class="clr"></div>
	<?php endif; ?>
