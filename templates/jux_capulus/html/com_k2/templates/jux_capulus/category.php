...
<div id="k2Container" class="clearfix itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListSubCategories">
			...
			<div class="subCategoryContainer<?php echo $lastContainer; ?> col-md-<?php echo 12/$subCatColumns; ?> col-sm-<?php echo 12/$subCatColumns; ?>">
	...
	<div class="itemList">
		...
		<div id="itemListPrimary">
			...
			<div class="itemContainer<?php echo $lastContainer; ?> <?php echo ($key%2) ? "itemcontainer-odd" : "itemcontainer-even"; ?>">
				<?php
					// Load category_item.php by default
					$this->item=$item;
					echo $this->loadTemplate('item');
